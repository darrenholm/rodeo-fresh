...
const TICKET_BLOCK = [
  ...
  '$35 adult / $80 family online — adults pay $40 at the gate. Buy online and save!',
].join('\n');
...
async function buildScheduleCard() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <text x="${W/2}" y="1198" text-anchor="middle" font-family="${FONT}" font-size="30" fill="${GR}">$35 online · $40 at the gate — buy online and save!</text>
