...
const TICKET_BLOCK = [
  ...
  'Online: $35 adult / $80 family +HST · Gate: $40 adult / $90 family — buy online to guarantee your spot & skip the line!',
].join('\n');
...
async function buildScheduleCard() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <text x="${W/2}" y="1198" text-anchor="middle" font-family="${FONT}" font-size="27" fill="${GR}">Online $35 adult / $80 family +HST · Gate $40 / $90 — buy online, skip the line!</text>
